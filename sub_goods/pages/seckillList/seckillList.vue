<template>
	<view :style="Theme">
		<uni-nav-bar leftIcon="arrowleft" fixed="true" title="限时秒杀" />
		<!-- 顶部时间 -->
		<sjuTime class="time-box" :timeList="timeList" @onChange="onChange"></sjuTime>
		<!-- 商品列表 -->
		<view class="goods-list">
			<view class="goods-item" @click="navTo(`/goods/goodsDetail?id=${item.id}&goodsType=seckill`)"
...
<style lang="scss" scoped>
	...
	.goods-list{
		padding: 0 4%;
		margin: calc(120upx + var(--statusBarHeight)) auto;
		.goods-item{
			height: auto;
			padding: 20upx;
			display: flex;
