<template>
	<view :style="Theme">
		...
		<view class="vipView">
			<view class="vipInfo">
				<view class="info-left">
					...
					<view class="vipExplain">
						普通会员普通商品可享95折
					</view>
				</view>
				<view @click="navTo('/member/memberCenter')" class="vipBtn">
					立即升级
				</view>
			</view>
		</view>
		...
		<!-- 功能服务 -->
		<view class="menu">
			<menuList leftIcon="icon-dingdan" menuName="我的订单" rightIcon="icon-right" @onClick="navTo('/my/orderList?id=0')" @clickRight="navTo('/my/orderList?id=0')"  />
			<menuList leftIcon="icon-shoucang" menuName="商品收藏" rightIcon="icon-right" @onClick="navTo('/my/collect')" @clickRight="navTo('/my/collect')"  />
			<menuList leftIcon="icon-concern" menuName="关注店铺" rightIcon="icon-right" @onClick="navTo('/my/concern')" @clickRight="navTo('/my/concern')"  />
			<menuList leftIcon="icon-dizhi" menuName="地址管理" rightIcon="icon-right" @onClick="navTo('/my/addressList')" @clickRight="navTo('/my/addressList')"  />
			<!-- <menuList leftIcon="icon-share" menuName="分享推荐" rightIcon="icon-right" @onClick="navTo('/my/setting')" @clickRight="navTo('/my/setting')"  /> -->
			<menuList leftIcon="icon-feedback" menuName="意见反馈" rightIcon="icon-right" @onClick="navTo('/my/feedback')" @clickRight="navTo('/my/feedback')"  />
			<menuList leftIcon="icon-common" menuName="常见问题" rightIcon="icon-right" @onClick="navTo('/my/issuesList')" @clickRight="navTo('/my/issuesList')"  />
			<menuList leftIcon="icon-setting" menuName="我的设置" rightIcon="icon-right" @onClick="navTo('/my/setting')" @clickRight="navTo('/my/setting')"  />
		</view>
